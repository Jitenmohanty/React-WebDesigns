...
const Stats = () => {
  const stats = [
    { icon: FaUsers, count: 85, label: "Team Size" },
    { icon: FaMagento, count: 60, label: "Certified Magento Experts" },
    { icon: FaGlobe, count: 5000, label: "Websites Launched" },
    { icon: FaHandshake, count: 80, label: "Collaborations" }
  ];
